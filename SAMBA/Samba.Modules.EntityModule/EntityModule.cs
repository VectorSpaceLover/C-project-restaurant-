...
namespace Samba.Modules.EntityModule
{
    ...
    class EntityModule : ModuleBase
    {
        ...
        protected override void OnInitialization()
        {
            ...
            _regionManager.RegisterViewWithRegion(RegionNames.ExtraButtonsRegion, typeof(EntitySwitcherView));
            ...
            _regionManager.RegisterViewWithRegion(RegionNames.MainRegion, typeof(EntitySelectorView));
            _regionManager.RegisterViewWithRegion(RegionNames.MainRegion, typeof(EntitySearchView));
            _regionManager.RegisterViewWithRegion(RegionNames.MainRegion, typeof(EntityEditorView));
            _regionManager.RegisterViewWithRegion(RegionNames.MainRegion, typeof(EntityDashboardView));
        ...
        private void ActivateEntityEditor()
        {
            ...
            _regionManager.ActivateRegion(RegionNames.MainRegion, _entityEditorView);
        }
        ...
        private void ActivateEntitySwitcher()
        {
            ...
            _regionManager.ActivateRegion(RegionNames.ExtraButtonsRegion, _entitySwitcherView);
        }
    }
}
