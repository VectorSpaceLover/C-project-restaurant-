...
namespace Samba.Modules.EntityModule
{
    ...
    public class EntitySwitcherViewModel : ObservableObject
    {
        ...
        private void OnSelectEntityCategoryExecuted(EntityScreen obj)
        {
            ...
            // Below force publishs the operation request because we dont use POS navigation button.
            ...
            EventServiceFactory.EventService.PublishEvent(EventTopicNames.EntitySwitched);
        }
        ...
        private void ActivateDashboard(EntityScreen entityScreen)
        {
            ...
            _regionManager.ActivateRegion(RegionNames.MainRegion, _entityDashboardView);
        }
        ...
        private void ActivateEntitySearcher(EntityScreen entityScreen)
        {
            ...
            _regionManager.ActivateRegion(RegionNames.MainRegion, _entitySearchView);
        }
        ...
        private void ActivateButtonSelector(EntityScreen entityScreen)
        {
            ...
            _regionManager.ActivateRegion(RegionNames.MainRegion, _entitySelectorView);
        }
    }
}
