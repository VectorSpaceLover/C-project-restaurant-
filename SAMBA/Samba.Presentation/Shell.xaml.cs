...
namespace Samba.Presentation
{
    ...
    public partial class Shell : Window
    {
        ...
        private readonly float _heightExtraButtonsRegion = 0.37F;
        ...
        public Shell(IApplicationState applicationState, IMethodQueue methodQueue)
        {
            ...
            EventServiceFactory.EventService.GetEvent<GenericEvent<EventAggregator>>().Subscribe(
                x =>
                {
                    if (x.Topic == EventTopicNames.ActivateNavigation)
                    {
                        ...
                        MainGrid.RowDefinitions[1].Height = new GridLength(_heightExtraButtonsRegion, GridUnitType.Star);
                    }
            ...
            ExtraButtons.Visibility = Visibility.Collapsed;
        ...
        public void UserLoggedIn(User user)
        {
            ...
            // Change row height of row 1 (ExtraButtonsRegion) of MainGrid after logged in
            MainGrid.RowDefinitions[1].Height = new GridLength(_heightExtraButtonsRegion, GridUnitType.Star);
        }
        ...
        public void UserLoggedOut(User user)
        {
            ...
            RightUserRegion.Visibility = Visibility.Collapsed;
            ExtraButtons.Visibility = Visibility.Collapsed;
            // change row height of row 1 (ExtraButtonsRegion) of MainGrid when logged out
            MainGrid.RowDefinitions[1].Height = GridLength.Auto;
        }
